...
QT_MOC_LITERAL(1, 8, 14), // "signalReadData"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 4), // "type"
QT_MOC_LITERAL(4, 29, 4), // "data"
QT_MOC_LITERAL(5, 34, 9), // "dataIndex"
QT_MOC_LITERAL(6, 44, 15), // "onNewConnection"
QT_MOC_LITERAL(7, 60, 11), // "onConnected"
QT_MOC_LITERAL(8, 72, 14), // "onDisconnected"
QT_MOC_LITERAL(9, 87, 11), // "onDataReady"
QT_MOC_LITERAL(10, 99, 14), // "onBytesWritten"
QT_MOC_LITERAL(11, 114, 5) // "bytes"

    },
    "CServer\0signalReadData\0\0type\0data\0"
    "dataIndex\0onNewConnection\0onConnected\0"
...
void CServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->signalReadData((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< QByteArray(*)>(_a[2])),(*reinterpret_cast< int(*)>(_a[3]))); break;
        case 1: _t->onNewConnection(); break;
        case 2: _t->onConnected(); break;
        case 3: _t->onDisconnected(); break;
        case 4: _t->onDataReady(); break;
        case 5: _t->onBytesWritten((*reinterpret_cast< qint64(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (CServer::*)(int , QByteArray , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CServer::signalReadData)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void CServer::signalReadData(int _t1, QByteArray _t2, int _t3)
{
