...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CStatusBar_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CStatusBar_t qt_meta_stringdata_CStatusBar = {
    {
        QT_MOC_LITERAL(0, 10)   // "CStatusBar"
    },
    "CStatusBar"
};
...
Q_CONSTINIT static const uint qt_meta_data_CStatusBar[] = {
...
Q_CONSTINIT const QMetaObject CStatusBar::staticMetaObject = { {
    QMetaObject::SuperData::link<CWidgetView::staticMetaObject>(),
    qt_meta_stringdata_CStatusBar.offsetsAndSizes,
    qt_meta_data_CStatusBar,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CStatusBar_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<CStatusBar, std::true_type>
    >,
    nullptr
} };
